...
La idea de esta heurística fue extraída del paper ``A branch-and-cut algorithm for graph coloring'' de Isabel Méndez Díaz y Paula Zabala, como se puede ver en la referencia \cite{cliquecutalgorithm}.
...
La idea del algoritmo fue extraída del paper ``Solving Airline Crew Scheduling Problems by Branch-and-Cut'' de Karla L. Hoffman y Manfred Padberg, como se puede ver en la referencia \cite{oddcyclecutalgorithm}.

\subsection{Flujo del algoritmo de Planos de Corte para el ejercicio 2}
