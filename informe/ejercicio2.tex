...
\item $$
      ...
      Como se puede observar, la restricción se cumple si existe algún $p$ tal que $X_{o,j_0} = 1$. Pero como se puede ver, esto pasa si y solo si hay un nodo pintado con el color $j_0$, pero esto no puede ser, ya que se había dicho que $W_{j_0} = 0$, que indica que el color $j_0$ no se usa. Por lo tanto llegamos a un absurdo.$\qed$
\end{itemize}
...
\item$$
      ...
      Lo cual resulta absurdo, ya que la solución era válida para el $CP$ original.$\qed$
\end{itemize}