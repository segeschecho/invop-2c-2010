...
Para encontrar la clique maximal se utilizó el algoritmo $New-Best-In$ del paper ``A Simple Clique Camouflaging Against Greedy Maximum Clique Heuristics'' de Stanislav Busygin que se puede ver en la referencia.
